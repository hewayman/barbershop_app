    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    apptModel = new AppointmentModel(-1, UserHomeActivity.isHaircutClicked, UserHomeActivity.isStyleClicked, UserHomeActivity.isColorClicked, UserHomeActivity.isShaveClicked, CalendarActivity.date, CalendarActivity.time);
                }
                catch(Exception e){

                    Toast.makeText(ConfirmationActivity.this, "Error Saving Appointment", Toast.LENGTH_SHORT).show();
                    apptModel = new AppointmentModel(-1, false, false, false, false, "error", "error");
                }

                DataBaseHelper dbHelper = new DataBaseHelper(ConfirmationActivity.this);

                boolean success = dbHelper.addNewAppointment(apptModel);
                Toast.makeText(ConfirmationActivity.this, "Success = " + success, Toast.LENGTH_SHORT).show();
